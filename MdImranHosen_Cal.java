...
public class MdImranHosen_Cal {
    ...
    */
    ...
    private MdImranHosen_Cal() {
        window = new JFrame("MdImranHosen_Cal");
        window.setSize(400,600); // Height And Width Of Window
        window.setLocationRelativeTo(null); // Move Window To Center
        
        Font btnFont = new Font("Comic Sans MS", Font.PLAIN, 26);
        
        choixColor = new JButton();
        choixColor.setBounds(220, 20, 140, 24);
        choixColor.setText("Colors Button");
        choixColor.setBackground(Color.BLUE.darker());
        ...
        inText.setBackground(Color.WHITE); // Show Value Box Background color 
    ...
    private void themeColor() {
        ...
        if (bool) {
            ...
            choixColor.setText("General Colors");
